 ...
 * @author higa
 */
public class SpeechBalanceAPI extends BaseAPI {
	 ...
	 * </p>
	 */
	public SpeechBalanceAPI() {
		ResourceBundle properties = ResourceBundleUtil.getBundle("speech_balance");
	...
	public Map<String, Object> parse() throws ParseException {
		SpeechBalanceAPIParser parser = new SpeechBalanceAPIParser();
		parser.parse(xml);

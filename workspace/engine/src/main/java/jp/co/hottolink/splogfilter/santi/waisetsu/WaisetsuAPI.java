package jp.co.hottolink.splogfilter.santi.waisetsu;
 ...
 *
 */
public class WaisetsuAPI extends BaseAPI {
	 ...
	 */
	public WaisetsuAPI() {
		ResourceBundle properties = ResourceBundleUtil.getBundle("waisetsu");
	...
	public Map<String, Object> parse() throws ParseException {
		WaisetsuAPIParser parser = new WaisetsuAPIParser();
		parser.parse(xml);
